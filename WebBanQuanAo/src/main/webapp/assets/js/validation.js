...
Validator({
    ...
    formGroupSelector: ".form-group",
    rules: [
        Validator.isRequire('#password-old', "Vui lòng nhập mật khẩu cũ"),
        Validator.isRequire('#password-new', "Vui lòng nhập mật khẩu mới"),
        Validator.isRequire('#password-confirm', "Vui lòng nhập lặp lại mật khẩu mới"),
        Validator.isConfirmed(
            "#password-confirm",
            () => {
                return document.querySelector("#form-change-pass #password-new").value;
            },
            "Mật khẩu lặp lại không chính xác"
        ),
    ],
});
