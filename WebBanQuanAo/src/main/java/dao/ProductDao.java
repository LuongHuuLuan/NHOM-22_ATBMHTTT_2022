...
//    }
	...
	public static String addProduct(String codeProduct, String nameProduct, String brand, double price_product,
			String description, String tag_product[], String color_product[], String size_product[], String thumbnail, String creator) throws SQLException {
	...
	public static InfoDelete deleteProduct(String codeProduct) {
		...
		try {
			...
			if (deleteImagesProduct(codeProduct, connection, infoDelete) == 1
				...
				deleteProductInCart(codeProduct, connection);
				preparedStatement = connection.prepareStatement(sql);
				preparedStatement.setString(1, codeProduct);
	...
	// delete order of product
	public static int deleteProductInCart(String codeProduct, Connection connection) {
		String sql = "DELETE FROM CHITIETGIO WHERE MA_SP = ?";
		PreparedStatement preparedStatement = null;
		try {
			preparedStatement = connection.prepareStatement(sql);
			preparedStatement.setString(1, codeProduct);
